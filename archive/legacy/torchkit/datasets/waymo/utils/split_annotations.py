# ==================================================================== #
# File name: split_annotations.py
# Author: Long H. Pham
# Date created: 08/02/2021
# The `torchkit.datasets.waymo.utils.split_annotations` implements the
# utility functions to split the original annotations to separated
# annotations files, each corresponding to each image.
# ==================================================================== #
import glob
import os
