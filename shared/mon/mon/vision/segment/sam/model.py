...
class SAM_B(SAM, ModelMixin):
    ...
    zoo : dict = box.Box({
        "sa1b": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/sam/sam_b/sa1b/sam_b_sa1b.pt",
            "num_classes": None,
        },
    })
...
class SAM_L(SAM, ModelMixin):
    ...
    zoo : dict = box.Box({
        "sa1b": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/sam/sam_l/sa1b/sam_l_sa1b.pt",
            "num_classes": None,
        },
    })
...
class SAM2_T(SAM, ModelMixin):
    ...
    zoo : dict = box.Box({
        "sa1b": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/sam2/sam2.1_t/sav/sam2.1_t_sav.pt",
            "num_classes": None,
        },
    })
...
class SAM2_S(SAM, ModelMixin):
    ...
    zoo : dict = box.Box({
        "sa1b": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/sam2/sam2.1_s/sav/sam2.1_s_sav.pt",
            "num_classes": None,
        },
    })
...
class SAM2_B(SAM, ModelMixin):
    ...
    zoo : dict = box.Box({
        "sa1b": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/sam2/sam2.1_b/sav/sam2.1_b_sav.pt",
            "num_classes": None,
        },
    })
...
class SAM2_L(SAM, ModelMixin):
    ...
    zoo : dict = box.Box({
        "sa1b": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/sam2/sam2.1_l/sav/sam2.1_l_sav.pt",
            "num_classes": None,
        },
    })
