...
checkpoint = {
	...
	# Default: `True`.
    "monitor": "loss_epoch",  # "loss_epoch",
    # Quantity to monitor. Default: `None` which will monitor `loss_epoch`.
    "mode": "min",
    # One of: [`min`, `max`]. For `acc`, this should be `max`, for `loss` this
	# should be `min`, etc.
    "verbose": True,
...
data = {
    ...
    # The datasets" name.
    "subset": "lol",
    # Type of dataset to use. One of: [`deepupe`, `dped`, `gladnet`, `lol`,
	# `sice`, `sid`]. Can also be a list. Default: `lol`.
    "exposure": "1",
    # The exposure level to used. Can also be a list.
    # - SICE dateset:
    #   [`1`, `2`, `3`, `4`, `5`, `6`, `5`] or `*`:
    #   The exposure level where `1` is the most under-exposure and `7` is
	#   the most over-exposure. `*` is all images. Default: `1`.
    "shape": [360, 640, 3],
...
model = {
    ...
    # The fullname of the model as: {name}_{data_name}. If `None`, the fullname
	...
	# Default: `-1`.
	"loss": None,
	# The loss config. Define in the code.
    "metrics": [
    ...
    "optimizers": [
        ...
        dict(name="adam", lr=0.00001),
    ],
    "schedulers": None,
    # The 2D-list of schedulers' configs. Each sub-list of dicts is
	# corresponded to an optimizer defined in
    # `optimizers`.
	"debugger": {
		"every_n_epochs": 10,
