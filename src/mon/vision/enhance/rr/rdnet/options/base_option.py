...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--name',                type=str,            default='ytmt_ucs_sirs', help='name of the experiment. It decides where to store samples and models')
        ...
        self.parser.add_argument('--nThreads',            type=int,            default=8,               help='# threads for loading data')
