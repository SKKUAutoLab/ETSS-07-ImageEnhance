...
class TrainOptions(BaseOptions):
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--finetune",              action="store_true",               help="finetune the network using identity inputs and outputs")
        self.parser.add_argument("--if_align",              action="store_true",               help="if align 4x")

        # self.parser.add_argument('--graph', action='store_true', help='print computation graph')
        ...
        self.parser.add_argument("--debug_eval",            action="store_true",                            help="if specified, do not flip the images for data augmentation")
