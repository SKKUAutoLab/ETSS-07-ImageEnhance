...
class lolv2(Dataset):
    ...
    def __init__(self, config, mode):
        ...
        if mode == "train":
            ...
            if config.f_valFromTrain and config.p_valList:  # USE 10% of training as validation
                with open(config.p_trainList) as f:
                    self.imList = [l.strip() for l in f.readlines()]
