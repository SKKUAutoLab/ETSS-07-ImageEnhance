...
"""KODAS 2D detection dataset and datamodule.
"""
...
__all__ = ["Kodas2020Detection2D", "Kodas2020Detection2DDataModule"]
...
Where:
	...
	<bbox_center_x>: The center's x coordinate of the bounding box.
	<bbox_center_y>: The center's y coordinate of the bounding box.
	<bbox_width>   : The width in pixels of the bounding box.
	<bbox_height>  : The height in pixels of the bounding box.
"""


# MARK: - Kodas2020Detection2D

@DATASETS.register(name="kodas2020_detection2d")
class Kodas2020Detection2D(Detection2DDataset):
	"""The Kodas2020 2D Detection Dataset consists of multiple sub-datasets
