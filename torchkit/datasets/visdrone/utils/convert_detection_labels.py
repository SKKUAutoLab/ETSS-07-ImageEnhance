# ==================================================================== #
# File name: convert_detection_labels.py
# Author: Long H. Pham
# Date created: 06/22/2021
# The `torchkit.datasets.visdrone.convert_detection_labels` implements
# the operations to convert the bounding box labels to different formats.
# ==================================================================== #
...
def convert_detection_labels(root_dir: str, format: str = "yolo"):
	...
	subdirs = list_subdirs(current_dir=root_dir)
	...
	create_dirs(dirs=output_dirs, delete_existing=True)
...
def _convert_labels_yolo(image_file: str, labels_file: str):
	...
	Args:
		image_file (str):
			The image file corresponding to the labels.
		labels_file (str):
...
if __name__ == "__main__":
	...
	if args.data_dir == "":
		data_dir = os.path.join(datasets_dir, "visdrone", "detection2019")
	else:
