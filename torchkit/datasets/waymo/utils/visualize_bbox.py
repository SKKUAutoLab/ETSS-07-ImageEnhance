# ==================================================================== #
# File name: visualize_bbox.py
# Author: Long H. Pham
# Date created: 08/24/2021
# The `torchkit.datasets.waymo.utils.visualize_bbox` implements the
# utility functions to visualize bboxes on images for debugging.
# ==================================================================== #
import glob
import os
import random
...
for split in splits:
	...
	classlabel_path    = os.path.join(datasets_dir, "waymo", "detection2d", f"classlabels.json")
	...
	for path in annotation_paths:
		...
		labels[:, 1:5] = bbox_cxcywh_norm_xyxy(labels[:, 1:5], shape0[0], shape0[1])
		colors         = classlabels.colors()
		print(labels)
